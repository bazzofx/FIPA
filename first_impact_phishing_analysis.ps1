...
Write-Host "Phishing Hunter v1.31 - module imported - PB" -ForegroundColor Gray 
...
$mailToUser                 = $res.mailToAddresses
Write-Host "Mail To : $mailToUser" -ForegroundColor Yellow
$ip                         = $res.mailSenderIp
